...
ace.general_things = function(a) {
	a('.ace-nav [class*="fa-animated-"]').closest("a").on("click",
			function() {
						...
						if (p == "collapse") {
							...
							if (p == "close") {
								...
								if (p == "reload") {
									...
									b
											.append('<div class="widget-box-overlay"><i class="fa fa-spinner fa-spin fa-2x white"></i></div>');
